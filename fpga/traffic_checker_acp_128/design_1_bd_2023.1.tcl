...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list CONFIG.PSU__USE__S_AXI_GP0   {0} ] $zynq_ultra_ps_e_0
  set_property -dict [list CONFIG.PSU__USE__S_AXI_ACP   {1} ] $zynq_ultra_ps_e_0
  ...
  set_property -dict [ list CONFIG.NUM_MI {1} ] $axi_interconnect_acp
  #
  # Connect
  #
  connect_bd_net -net SYS_CLK0   [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]           \
                                 ...
                                 [get_bd_pins axi_interconnect_acp/ACLK]           \
                                 [get_bd_pins axi_interconnect_acp/S00_ACLK]       \
                                 [get_bd_pins axi_interconnect_acp/M00_ACLK]       \
                                 [get_bd_pins ZYNQMP_ACP_ADAPTER_0/ACLK]           \
  ...
  connect_bd_net -net SYS_RESETN [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
                                 ...
                                 [get_bd_pins axi_interconnect_acp/ARESETN]        \
                                 [get_bd_pins axi_interconnect_acp/S00_ARESETN]    \
                                 [get_bd_pins axi_interconnect_acp/M00_ARESETN]    \
                                 [get_bd_pins ZYNQMP_ACP_ADAPTER_0/ARESETn]        \
  ...
  connect_bd_intf_net -intf_net AXI_ACP     -boundary_type upper [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_ACP_FPD]   [get_bd_intf_pins ZYNQMP_ACP_ADAPTER_0/ACP]
  connect_bd_intf_net -intf_net AXI_MEM     -boundary_type upper [get_bd_intf_pins ZYNQMP_ACP_ADAPTER_0/AXI]   [get_bd_intf_pins axi_interconnect_acp/M00_AXI]
  ...
  connect_bd_intf_net -intf_net AXI_TC0_M   -boundary_type upper [get_bd_intf_pins axi_interconnect_acp/S00_AXI] [get_bd_intf_pins AXI_TRAFFIC_CHECKER_0/M]
  #
  # Assign Address Map
  #
  ...
  create_bd_addr_seg -range  0x80000000 -offset  0x00000000 [get_bd_addr_spaces ZYNQMP_ACP_ADAPTER_0/ACP] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_LOW ] SEG_zynq_ultra_ps_e_0_ACP_DDR_LOW
  create_bd_addr_seg -range 0x100000000 -offset 0x800000000 [get_bd_addr_spaces ZYNQMP_ACP_ADAPTER_0/ACP] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_HIGH] SEG_zynq_ultra_ps_e_0_ACP_DDR_HIGH
